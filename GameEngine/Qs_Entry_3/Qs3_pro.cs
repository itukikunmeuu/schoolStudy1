...
namespace Qs3_inheritance
{
    ...
    public class Vector3 : BaseVector
    {
        ...
        public Vector3(BaseVector v) : base(v) { }
    ...
    abstract class AbstVector
    {
        ...
        public abstract void GetMgunitude();

    }
    class Show : AbstVector
    {
        public override float X { get { return X;} }
        public override float Y { get { return Y; } }
        public override float Z { get { return Z;}}
    }
    class GetMgunitude : AbstVector
    {
        public override float X { get { return X; } }
        public override float Y { get { return Y;} }
        public override float Z { get { return Z;}}
